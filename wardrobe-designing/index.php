...
<head>
    ...
    <title>Wardrobe Designing - <?PHP echo PRIMARY_INFO['NAME']; ?> - <?php echo PRIMARY_INFO['TAGLINE']; ?></title>
    ...
    <div id="wrapper">
        ...
        <section id="subheader" style="background-image: url('<?php echo STORAGE_URL; ?>/background/subheader-5.jpg');" data-speed="8" data-type="background">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>Wardrobe Designing</h1>
                        <ul class="crumb">
                            <li><a href="<?php echo DOMAIN; ?>">Home</a></li>
                            <li class="sep">/</li>
                            <li>Wardrobe Designing</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div id="content-sidebar" class="nopadding">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-3">
                            Elevate your storage solutions with ECOTECH Homes' wardrobe designs in Gurgaon. Our premium interior solutions blend functionality and style seamlessly, offering bespoke wardrobes that maximize space while reflecting your unique taste. From sleek finishes to innovative organization systems, we prioritize creating wardrobes that not only enhance your home but also simplify your daily routine. Experience the perfect combination of premium design and affordability with ECOTECH Homes' wardrobe designs, setting a new standard for elegance in Gurgaon.</div>
                    </div>
                </div>
                <div class="spacer-single"></div>
            </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="container mb-5" style="display: contents;">
                        <div class="row">
                            <?php if ($handle = opendir(__DIR__ . "/../storage/projects/wardrobe-designs")) {
                            ...
                            ?>
                                            <div class="col-md-4 col-sm-6 col-6">
                                                <div class="p-2 project-images2">
                                                    <img src="<?php echo STORAGE_URL; ?>/projects/wardrobe-designs/<?php echo $entry; ?>" class="img-fluid ratio-1x1">
                                                </div>
                                            </div>
                            <?php
                                        }
