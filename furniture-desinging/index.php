...
<head>
    ...
    <title>Furniture Designing - <?PHP echo PRIMARY_INFO['NAME']; ?> - <?php echo PRIMARY_INFO['TAGLINE']; ?></title>
        ...
        <div id="content-sidebar" class="nopadding">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-3">
                            Transform your living space with ECOTECH Homes' exceptional furniture designs in Gurgaon. Our premium interior solutions seamlessly blend functionality and aesthetics, offering bespoke furniture pieces that elevate your home decor. From sleek modern designs to timeless classics, we prioritize creating furniture that reflects your unique style and enhances your lifestyle. Experience the perfect fusion of premium craftsmanship and affordability with ECOTECH Homes' furniture designs, setting a new benchmark for elegance in Gurgaon.</div>
                    </div>
                </div>
                <div class="spacer-single"></div>
            </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="container mb-5" style="display: contents;">
                        <div class="row">
                            <?php if ($handle = opendir(__DIR__ . "/../storage/projects/furniture-designs")) {
                            ...
                            ?>
                                            <div class="col-md-4 col-sm-6 col-6">
                                                <div class="p-2 project-images2">
                                                    <img src="<?php echo STORAGE_URL; ?>/projects/furniture-designs/<?php echo $entry; ?>" class="img-fluid ratio-1x1">
                                                </div>
                                            </div>
                            <?php
                                        }
