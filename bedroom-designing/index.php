...
<head>
    ...
    <title>Bedroom Designing - <?PHP echo PRIMARY_INFO['NAME']; ?> - <?php echo PRIMARY_INFO['TAGLINE']; ?></title>
        ...
        <div id="content-sidebar" class="nopadding">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-3">
                            "Experience tranquility and comfort in your bedroom with ECOTECH Homes' bespoke designs in Gurgaon. Our premium interior solutions ensure that every aspect of your bedroom reflects luxury and affordability, creating a space where you can unwind and rejuvenate. From soothing color palettes to ergonomic furniture arrangements, we prioritize creating an atmosphere of relaxation and serenity. Transform your bedroom into a sanctuary of comfort and style with ECOTECH Homes, where premium design meets affordability in Gurgaon."
                        </div>
                    </div>
                </div>
                <div class="spacer-single"></div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="container mb-5" style="display: contents;">
                        <div class="row">
                            <?php if ($handle = opendir(__DIR__ . "/../storage/projects/bedrooms-designs")) {
                            ...
                            ?>
                                            <div class="col-md-4 col-sm-6 col-6">
                                                <div class="p-2 project-images2">
                                                    <img src="<?php echo STORAGE_URL; ?>/projects/bedrooms-designs/<?php echo $entry; ?>" class="img-fluid ratio-1x1">
                                                </div>
                                            </div>
                            <?php
                                        }
